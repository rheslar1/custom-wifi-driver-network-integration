...
```bash
./build/custom_wi_fi_driver_compilation___network_integration --nominal
./build/custom_wi_fi_driver_compilation___network_integration --unsafe
./build/custom_wi_fi_driver_compilation___network_integration --offline
```
