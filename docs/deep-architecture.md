# Custom Wi-Fi Driver Compilation & Network Integration Deep Architecture
...
C++17, C++ Design Patterns, SOLID, Linux kernel, Wi-Fi driver, Kernel module, Device tree, Cross-compilation, Sockets
...
- Test coverage: `tests/WifiIntegrationTests.cpp`
